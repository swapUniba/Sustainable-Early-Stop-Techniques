...
def run_recbole(
    ...
    print("Out per capire device: ", config["device"])
    ...
    best_valid_score, best_valid_result = trainer.fit(
        train_data, max_emission_step, trade_off, emission_file_path, proj_name, valid_data, saved=saved, show_progress=config["show_progress"]
    )
